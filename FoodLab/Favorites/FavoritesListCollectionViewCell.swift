//
//  FavoritesListCollectionViewCell.swift
//  FoodLab
//
//  Created by Antoine Lucchini on 26/01/2023.
//

import UIKit

class FavoritesListCollectionViewCell: UICollectionViewCell {
    ...
    static let reuseIdentifier = String(describing: FavoritesListCollectionViewCell.self)
